$( document ).ready(function() 
    {
        $("#submitButton").click(function()
        {
            ...
            //         "mtaapi.herokuapp.com/stop?id=" + st1,
            //         function(response) {
            //             return response;
            //         }
            //     );
            // var stop1Name = result.name;
            ...
            //    &key=YOUR_API_KEY
            var map_url = "https://maps.googleapis.com/maps/api/staticmap?zoom=16&size=2000x2000&markers=color:red%7Clabel:A%7C40.752769,-73.979189&markers=color:blue%7Clabel:B%7C40.754222,-73.984569&markers=color:green%7Clabel:C%7C40.758663,-73.981329&key=AIzaSyDNANuHlcA_sZOsF0RZUflUujnwRdhDpIQ";
